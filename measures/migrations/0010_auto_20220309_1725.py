# Generated by Django 3.1.14 on 2022-03-09 17:25

from django.db import migrations, models

CERTIFICATE_ONLY_CODES = ["A", "B", "C", "H", "Q", "Y", "Z"]
PRICE_ONLY_CODES = ["F", "L", "M", "R", "U", "V"]
CERTIFICATE_AND_PRICE_CODES = ["E", "I"]

REQUIRES_DUTY_CODES = ["01", "02", "03", "11", "12", "13", "15"]
...
def forwards(apps, schema_editor):
    ...
    codes = MeasureConditionCode.objects.latest_approved()
    for code in codes:
    ...
    actions = MeasureAction.objects.latest_approved()
