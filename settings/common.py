...
SQLITE_S3_ACCESS_KEY_ID = os.environ.get("SQLITE_S3_ACCESS_KEY_ID")
SQLITE_S3_SECRET_ACCESS_KEY = os.environ.get("SQLITE_S3_SECRET_ACCESS_KEY")
SQLITE_S3_ENDPOINT_URL = os.environ.get("SQLITE_S3_ENDPOINT_URL")
