...
@pytest.fixture
@when("I view a geographical_area with id 1001")
def geo_area_detail_description(client, geographical_area_1001):
    url = reverse(
        "geo_area-ui-detail-descriptions",
        kwargs={"sid": geographical_area_1001.sid},
    )
...
@pytest.fixture
@when("I view a geographical_area with id 1001")
def geo_area_detail_memberships(client, geographical_area_1001):
    url = reverse(
        "geo_area-ui-detail-memberships",
        kwargs={"sid": geographical_area_1001.sid},
    )
    return client.get(url)
...
@pytest.fixture
@when("I view a geographical_area with id 1002")
def geo_area_group_detail_members(client, geographical_area_1002):
    url = reverse(
        "geo_area-ui-detail-memberships",
        kwargs={"sid": geographical_area_1002.sid},
    )
    return client.get(url)
...
def geo_area_description_data(geo_area_detail_description, geographical_area_1001):
    descriptions = geographical_area_1001.descriptions.all()

    content = geo_area_detail_description.content.decode()
