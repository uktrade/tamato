...
class TestMeasurementUnitQualifierDescriptionParserV2:
    """
    Example XML:
    ...
    target_parser_class = MeasurementUnitQualifierDescriptionParserV2
    ...
    def test_import_update(self, superuser):
        ...
        importer = preload_import(
            "measurement_unit_qualifier_description_UPDATE.xml",
            __file__,
        )
