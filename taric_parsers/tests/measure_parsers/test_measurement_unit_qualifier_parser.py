...
class TestMeasurementUnitQualifierParserV2:
    """
    Example XML:
    ...
    target_parser_class = MeasurementUnitQualifierParserV2
    ...
    def test_import(self, superuser):
        importer = preload_import("measurement_unit_qualifier_CREATE.xml", __file__)
    ...
    def test_import_update(self, superuser):
        ...
        importer = preload_import("measurement_unit_qualifier_UPDATE.xml", __file__)
