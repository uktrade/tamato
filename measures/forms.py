...
class SerializableFormMixin:
    ...
    def serialize_date(self, date: Optional[datetime.date]) -> Optional[str]:
        """
        " Serialize a date instance, which may be None, to a string
        representation whose format is DATE_STRING_FORMAT.
...
class MeasureDetailsForm(
    ...
    def serializable_cleaned_data(self) -> Dict:
        cleaned_data = dict()
        # TODO: Guard against KeyError exceptions and referencing attrs on None. try/except?
