...
ENVELOPE_GENERATION_DEFAULT_RETRY_DELAY = int(
    os.environ.get("ENVELOPE_GENERATION_DEFAULT_RETRY_DELAY", CELERY_MAX_RETRIES),
)
...
NOTIFICATIONS_API_DEFAULT_RETRY_DELAY = int(
    os.environ.get("NOTIFICATIONS_API_DEFAULT_RETRY_DELAY", CELERY_MAX_RETRIES),
)
