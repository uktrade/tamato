...
from measures.new_import_parsers import NewMeasureTypeSeriesDescriptionParser

pytestmark = pytest.mark.django_db


@pytest.mark.new_importer
class TestNewMeasureTypeSeriesDescriptionParser:
    """
    Example XML:
    ...
    target_parser_class = NewMeasureTypeSeriesDescriptionParser

    def test_it_handles_population_from_expected_data_structure(self):
        expected_data_example = {
            "measure_type_series_id": "AB",
            "language_id": "ZZ",
        ...
        assert target.sid == "AB"
        assert target.description == "Some Description"

    def test_import(self, superuser):
        importer = preload_import(
            "measure_type_series_description_CREATE.xml",
            __file__,
        )
    ...
    def test_import_update(self, superuser):
        preload_import("measure_type_series_description_CREATE.xml", __file__, True)
        importer = preload_import(
            "measure_type_series_description_UPDATE.xml",
            __file__,
        )
    ...
    def test_import_delete(self, superuser):
        preload_import("measure_type_series_description_CREATE.xml", __file__, True)
        importer = preload_import(
            "measure_type_series_description_DELETE.xml",
            __file__,
        )
