...
def test_additional_code_type_measure_type_xml(
    api_client, taric_schema, approved_workbasket, approved_transaction, xml
):
...
def test_measure_component_xml(
    api_client, taric_schema, approved_workbasket, approved_transaction, xml
):
...
def test_measure_condition_xml(
    api_client, taric_schema, approved_workbasket, approved_transaction, xml
):
...
def test_measure_type_series_xml(
    api_client, taric_schema, approved_workbasket, approved_transaction, xml
):
