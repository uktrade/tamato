...
class TestMeasureTypeDescriptionParserV2:
    """
    Example XML:
    ...
    target_parser_class = MeasureTypeDescriptionParserV2
    ...
    def test_import_update(self, superuser):
        ...
        importer = preload_import("measure_type_description_UPDATE.xml", __file__)
