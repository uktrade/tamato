    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                13,
                "start_month",
                "Start month is not valid, it must be between 1 and 12",
            ),
            ...
            (
                0,
                "end_year",
                f"End year is not valid, it must be a 4 digit year, greater than 2010, less than {date.today().year + 100} or blank",
            ),
            (
                1980,
                "end_year",
