...
class TestRefQuotaSuspensionRangeCreateUpdateForm:
    ...
    def test_clean_ref_quota_definition_range(self):
        ...
        target.cleaned_data['ref_quota_definition_range'] = ref_quota_definition_range.id
        assert target.clean_ref_quota_definition_range() == ref_quota_definition_range.id
