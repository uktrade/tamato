...
def test_additional_code_type_xml(api_client, taric_schema, xml):
...
def test_additional_code_description_xml(api_client, taric_schema, xml):
...
def test_additional_code_xml(api_client, taric_schema, xml):
