...
class TestNewQuotaEventParser:
    ...
    def test_it_handles_population_from_expected_data_structure_quota_balance_event(
        ...
        assert target.data == '{"reopening.date": "2020-01-01"}'

    def test_import(self, superuser):
        importer = preload_import("quota_reopening_event_CREATE.xml", __file__)
    ...
    def test_import_update(self, superuser):
        preload_import("quota_reopening_event_CREATE.xml", __file__, True)
        importer = preload_import("quota_reopening_event_UPDATE.xml", __file__)
    ...
    def test_import_delete(self, superuser):
        preload_import("quota_reopening_event_CREATE.xml", __file__, True)
        importer = preload_import("quota_reopening_event_DELETE.xml", __file__)
