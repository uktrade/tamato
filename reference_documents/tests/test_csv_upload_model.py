...
from reference_documents.models import ReferenceDocumentVersionStatus, CSVUpload
from reference_documents.models import RefOrderNumber
from reference_documents.tests import factories
from reference_documents.tests.factories import RefOrderNumberFactory, CSVUploadFactory
...
class TestCsvUpload:
    ...
    def test_csv_content_types(self):
        ...
        assert target.csv_content_types() == 'Preferential rates, Order numbers, Quota definitions'
