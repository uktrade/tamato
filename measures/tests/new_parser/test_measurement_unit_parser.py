...
from measures.new_import_parsers import NewMeasurementUnitParser

pytestmark = pytest.mark.django_db


@pytest.mark.new_importer
class TestNewMeasurementUnitParser:
    """
    Example XML:
    ...
    target_parser_class = NewMeasurementUnitParser
    ...
    def test_import(self, superuser):
        importer = preload_import("measurement_unit_CREATE.xml", __file__)
    ...
    def test_import_update(self, superuser):
        ...
        importer = preload_import("measurement_unit_UPDATE.xml", __file__)
