...
def test_certificate_type_xml(api_client, taric_schema, xml):
...
def test_certificate_description_xml(api_client, taric_schema, xml):
...
def test_certificate_xml(api_client, taric_schema, xml):
