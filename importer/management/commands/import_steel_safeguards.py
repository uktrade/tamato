...
class SteelSafeguardsImporter(RowsImporter):
    ...
    def _create_safeguard_larger_trader_group(self):
        yield from self._create_geo_area_group(
            group_area_sid=497,
            group_area_id='5051',
            group_area_description_sid=1416,
            group_description='Countries subject to UK safeguard measures (large traders)',
    ...
    def _create_safeguard_other_countries_group(self):
        ...
        yield from self._create_geo_area_group(
            group_area_sid=496,
            group_area_id='5050',
            group_area_description_sid=1415,
            group_description='Countries subject to UK safeguard measures',
            member_sids=member_sids,
        )

    def _create_geo_area_group(
            self,
            group_area_sid,
            group_area_id,
        ...
        group_area_description = GeographicalAreaDescription(
            sid=group_area_description_sid,
        ...
        member_sids_list = list(member_sids)
        member_sids_list.sort()
        for sid in member_sids_list:
