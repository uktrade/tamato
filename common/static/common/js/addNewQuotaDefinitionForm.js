...
const addNewForm = (event) => {
  ...
  newForm.innerHTML = newForm.innerHTML.replaceAll(
    'name="volume_0"',
    'name="volume_' + formCounter + '"',
  );
  newForm.innerHTML = newForm.innerHTML.replaceAll(
    'name="start_date_0_0"',
    'name="start_date_' + formCounter + '_0"',
  );
  newForm.innerHTML = newForm.innerHTML.replaceAll(
    'name="start_date_0_1"',
    'name="start_date_' + formCounter + '_1"',
  );
  newForm.innerHTML = newForm.innerHTML.replaceAll(
    'name="start_date_0_2"',
    'name="start_date_' + formCounter + '_2"',
  );
  newForm.innerHTML = newForm.innerHTML.replaceAll(
    'name="end_date_0_0"',
    'name="end_date_' + formCounter + '_0"',
  );
  newForm.innerHTML = newForm.innerHTML.replaceAll(
    'name="end_date_0_1"',
    'name="end_date_' + formCounter + '_1"',
  );
  newForm.innerHTML = newForm.innerHTML.replaceAll(
    'name="end_date_0_2"',
    'name="end_date_' + formCounter + '_2"',
  );

  let removeFormID = "form-remove_" + formCounter;
  newForm.insertAdjacentHTML(
    "beforeend",
    `<div><a id="${removeFormID}" class="govuk-link govuk-form-group remove-quota-definition" href="#" style="font-size:19px" >Remove</a><br></div>`,
  );
