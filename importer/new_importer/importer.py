...
from importer.parsers import NewElementParser
...
class MessageInfo:
    ...
    def __init__(self, message: bs4.Tag):
        ...
        self.transaction_id = message.find("oub:transaction.id").value
        self.record_code = message.find("oub:record.code").value
        self.subrecord_code = message.find("oub:subrecord.code").value
        self.sequence_number = message.find("oub:record.sequence.number").value
        self.update_type = int(message.find("oub:update.type").text)
        self.object_type = ""
        # get object type
        sibling = message.find("oub:update.type").next_sibling
