...
from reference_documents.forms.reference_document_csv_upload_forms import ReferenceDocumentCreateCsvUploadForm
...
class ReferenceDocumentCsvUploadList(PermissionRequiredMixin, WithPaginationListMixin, ListView):
...
class ReferenceDocumentCsvUploadCreateSuccess(PermissionRequiredMixin, TemplateView):
    template_name = "reference_documents/reference_document_csv_upload/create_success.jinja"
    permission_required = "reference_documents.add_csvupload"