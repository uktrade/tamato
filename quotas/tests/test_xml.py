...
def test_quota_order_number_xml(
...
def test_quota_association_xml(
    api_client, taric_schema, approved_workbasket, approved_transaction, xml
):
...
def test_quota_event_xml(
    ...
    test_event_type(api_client, taric_schema, approved_workbasket, approved_transaction)
