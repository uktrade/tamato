...
#echo running 19
#date
#python manage.py import_taric seed.xml --skip-split -f DIT200019.xml -d deltas
#echo running 20
#date
#python manage.py import_taric seed.xml --skip-split -f DIT200020.xml -d deltas
#echo running 21
#date
#python manage.py import_taric seed.xml --skip-split -f DIT200021.xml -d deltas
#echo running 22
#date
#python manage.py import_taric seed.xml --skip-split -f DIT200022.xml -d deltas
#echo running 23
#date
#python manage.py import_taric seed.xml --skip-split -f DIT200023.xml -d deltas
#echo running 24
#date
#python manage.py import_taric seed.xml --skip-split -f DIT200024.xml -d deltas
echo running 25
date
python manage.py import_taric seed.xml --skip-split -f DIT200025.xml -d deltas
date