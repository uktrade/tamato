...
def approved_workbasket():
    return factories.ApprovedWorkBasketFactory()


@pytest.fixture
def approved_transaction(approved_workbasket):
    workbasket_transaction = factories.WorkBasketTransactionFactory(
        workbasket=approved_workbasket,
    )
    return workbasket_transaction.transaction
