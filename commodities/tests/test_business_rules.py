...
def test_NIG11_first_indent_must_have_same_start_date(date_ranges):
    """The start date of the first indentation must be equal to the start date of the
    nomenclature.
    """
...
def test_NIG21(date_ranges):
    """The start date of the association with a footnote must be less than or equal to
