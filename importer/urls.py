...
commodity_importer_urlpatterns = [
    ...
    path(
        "commodity-importer/<pk>/details/",
        views.CommodityImportDetails.as_view(),
        name="commodity_importer-ui-details",
    ),
    path(
    ...
    path(
        "review-imported-goods/<pk>/",
        views.ImportedGoodsReview.as_view(),
        name="review-imported-goods",
    ),
]
