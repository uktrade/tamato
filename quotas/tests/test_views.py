...
def test_update_quota_definition_page_200(valid_user_client_workbasket):
    quota_definition = factories.QuotaDefinitionFactory.create()
...
def test_update_quota_definition(valid_user_client_workbasket, date_ranges):
    quota_definition = factories.QuotaDefinitionFactory.create(
        valid_between=date_ranges.big_no_end,
    )
    url = reverse("quota_definition-ui-edit", kwargs={"sid": quota_definition.sid})
...
def test_delete_quota_definition_page_200(valid_user_client_workbasket):
    quota_definition = factories.QuotaDefinitionFactory.create()
...
def test_delete_quota_definition(valid_user_client_workbasket, date_ranges):
    quota_definition = factories.QuotaDefinitionFactory.create(
        valid_between=date_ranges.big_no_end,
    )
    url = reverse("quota_definition-ui-delete", kwargs={"sid": quota_definition.sid})

    response = valid_user_client_workbasket.post(url, {"submit": "Delete"})
    assert response.status_code == 302
    assert response.url == reverse(
    ...
    confirm_response = valid_user_client_workbasket.get(response.url)
...
def test_quota_order_number_create_200(
    ...
    response = valid_user_client_workbasket.get(reverse("quota-ui-create"))
...
def test_quota_order_number_create_errors_required(
    ...
    response = valid_user_client_workbasket.post(reverse("quota-ui-create"), form_data)
...
def test_quota_order_number_create_success(
    ...
    response2 = valid_user_client_workbasket.get(response.url)
